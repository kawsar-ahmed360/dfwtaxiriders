        ...
        <div class="container">
            <div class="tab-content">
                <div class="registration-form">
                    <form action="{{ route('BookingPost') }}" id="msform" class="msform user-register-form booking-form"
                        method="POST" data-multi-step>
                        @csrf
                                ...
                                <div class="info-forms">
                                    <div class="single-forms">
                                        <div class="input-single mt-30">
                                            ...
                                            <select class="Select form--control trip-type-get" name="trip_type"
                                        ...
                                        <div class="input-single mt-30">
                                            ...
                                            <select class="Select form--control occasion-select" name="occasion"
                                                id="occasion" required>
                                    ...
                                    <div class="single-forms">
                                        <div class="input-single mt-30">
                                            ...
                                            <select class="Select form--control" name="total_passengers"
                                                id="total_passengers" required>
                                                <option value="" class="placeholder" disabled selected>Total
                                                    Passengers...</option>
                                        ...
                                        <div class="input-single mt-30">
                                            ...
                                            <select class="Select form--control" name="luggage" id="luggage" required>
                                                <option value="" class="placeholder" disabled selected>Luggage...
                                                </option>
                                    ...
                                    <div class="single-forms">
                                        <div class="input-single mt-30">
                                            ...
                                            <input type="text" class="form--control datepicker hours_cal_pickup_date"
                                                data-provide="datepicker" name="pickup_date" id="pickup_date"
                                    ...
                                    <div class="single-forms">
                                        <div class="input-single mt-30">
                                            ...
                                            <input type="text" class="form--control datepicker hours_cal_drop_date"
                                                name="drowp_date" id="drowp_date" data-provide="datepicker"
                                        ...
                                        <div class="input-single mt-30">
                                            ...
                                            {{-- <input type="text" class="form--control timepicker hours_cal_drop_time"
                                    ...
                                    <div class="single-forms">
                                        <div class="input-single mt-30">
                                            ...
                                            <input class="form--control" type="text" name="pickup_location"
                                                id="pickupLocation" placeholder="Pick up address *" required />
                                        </div>
                                        <div class="input-single mt-30">
                                            <span class="login-icon">
                                                <i class="fa fa-map-marker"></i>
                                            </span>
                                            <input class="form--control" type="text" name="drowp_location"
                                                id="dropLocation" placeholder="Drop off address *" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <input type="button" name="name" class="button hours_show first-step-next md-mb-60"
                                    value="Choose a vehicle" data-next />
                            </div>
                        </fieldset>
                        <fieldset class="fieldset-service row mt-60" data-step>
                                    ...
                                    <div class="col-lg-3 mt-30 order-2 order-lg-1">
                                        <div class="booking-summery">
                                            <div class="booking-summery-details bg-gray">
                                                ...
                                                <div class="summery-single">
                                                    <span>FROM - TO</span>
                                                    <h6><span id="pickup_address_text"></span> - <span
                                                            id="drowp_address_text"></span></h6>
                                                </div>
                                                <div class="summery-single">
                                                    <span>PICKUP DATE, TIME</span>
                                                    <h6><span id="pickup_date_text"></span>, <span
                                                            id="pickup_time_text"></span></h6>
                                                </div>
                                                <div class="summery-single">
                                                    <span>DROP OFF DATE, TIME</span>
                                                    <h6><span id="drop_date_text"></span>, <span
                                                            id="drop_time_text"></span></h6>
                                                </div>
                                                <div class="summery-single">
                                                                    ...
                                                                    <table class="table">
                                                                        <thead>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th scope="col">10 <span>miles</span>
                                                                                </th>
                                                                                <th scope="col">20 <span>miles</span>
                                                                                </th>
                                                                                <th scope="col">30 <span>miles</span>
                                                                                </th>
                                                                                <th scope="col">40 <span>miles</span>
                                                                                </th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                            ...
                            <div class="col-md-12 mb-60">
                                <input type="button" name="name" class="button next-button"
                                    value="Enter Contact Details" data-next data-vehicle-select />
                                <input type="button" name="name" class="button-previous" value="Choose Ride Details"
                                    data-previous />
                            </div>
                        </fieldset>
                        <fieldset class="fieldset-info row mt-60" data-step>
                                    ...
                                    <div class="col-lg-3 mt-30 order-2 order-lg-1">
                                        <div class="booking-summery">
                                            ...
                                            <div class="booking-summery-details bg-gray">
                                                ...
                                                <div class="summery-single">
                                                    <span>FROM - TO</span>
                                                    <h6><span id="pickup_address_text_second"></span> - <span
                                                            id="drowp_address_text_second"></span></h6>
                                                </div>
                                                <div class="summery-single">
                                                    <span>PICKUP DATE, TIME</span>
                                                    <h6><span id="pickup_date_text_second"></span>, <span
                                                            id="pickup_time_text_second"></span></h6>
                                                </div>
                                                <div class="summery-single">
                                                    <span>DROP OFF DATE, TIME</span>
                                                    <h6><span id="drop_date_text_second"></span>, <span
                                                            id="drop_time_text_second"></span></h6>
                                                </div>
                                                <div class="summery-single">
                                                    <span>TOTAL PASSENGER</span>
                                    ...
                                    <div class="col-lg-9 order-1 order-lg-2">
                                            ...
                                            <div class="single-forms">
                                                <div class="input-single mt-30">
                                                    ...
                                                    <input type="tel" name="phone"
                                                        placeholder="Primary Phone Number*" class="form--control"
                                                        required />
                                                ...
                                                <div class="input-single mt-30">
                                                    ...
                                                    <input type="tel" name="second_phone"
                                                        placeholder="Secondary Phone Number*" class="form--control"
                                                        required />
                                        ...
                                        <div class="booking-checkbox bg-gray">
                                            <div class="checkbox-inlines">
                                                <input class="check-input" name="billing_checked" id="billing_checked"
                                                    type="checkbox" />
                                                <label class="checkbox-label" for="billing_checked"> Billing Adress
                                                </label>
                                            </div>
                                        </div>
                                        <div class="info-forms bg-gray" id="billing-address">
                                            <div class="single-forms">
                                                <div class="input-single mt-30">
                                                    ...
                                                    <input type="text" name="company_resgister_name"
                                                        placeholder="Company Registered Name" class="form--control" />
                                                </div>
                                                <div class="input-single mt-30">
                                                    <span class="login-icon">
                                                        <i class="fa fa-pencil-square-o"></i>
                                                    </span>
                                                    <input type="text" name="text_number" placeholder="Tax Number"
                                                        class="form--control" />
                                                </div>
                                            </div>
                                            <div class="single-forms">
                                        ...
                                        <div class="booking-checkbox bg-gray mt-60">
                                            <div class="checkbox-inlines">
                                                <input class="check-input" name="coupon_checked" id="coupon_checked"
                                                    type="checkbox" />
                                        ...
                                        <div class="info-forms bg-gray" id="coupon">
                                            <div class="single-forms">
                                                <div class="input-single mt-30">
                                                    ...
                                                    <input type="text" name="coupon_name" id="coupon_field"
                                                        placeholder="Enter Coupon Code" class="form--control" />
                                                    <input type="hidden" id="coupon_id" name="coupon_id">
                                                </div>
                                                <button style="margin-top: 28px;padding: 16px;" type="button"
                                                    id="coupon_applay" class="btn btn-success btn-sm">Apply</button>
                                                <button style="margin-top: 28px;padding: 16px;display:none" type="button"
                                                    id="coupon_done" class="btn btn-success btn-sm">Applied</button>
                                            </div>
                            ...
                            <div class="col-md-12 mb-60">
                                <input type="submit" name="submit" class="button" id="confirm_bokking"
                                    value="Confirm Booking" />

                                <input type="button" name="name" class="button-previous" value="Choose A vehicle"
                                    data-previous />
                            </div>
                        </fieldset>
...
@section('footer')
    ...
    <script>
        $(document).ready(function() {
            ...
            const allOccasions = [
                "Airport", "Airport (Arrival)", "Airport (Departure)",
                "Anniversary", "Bachelor", "Birthday", "City Tour", "City Transfer",
                "Concert", "Corporate", "Cruise Ship Transfer", "Dinner Outing",
                "Drive Around", "Funeral", "Gentlemans Night", "Graduation",
                "Halloween Tour", "Hen Party", "Holiday Light Tour", "Just For Fun",
                "Ladies Night", "Marriage Proposal", "Medical", "Night Out", "Other",
                "Prom", "Quinceañera", "Seaport", "Sightseeing", "Staff Party",
                "Sweet 16", "Tasting Tour", "Tour", "Transfer", "Wedding", "Wine Tour"
            ];

            const flatRateOccasions = ["Airport", "Airport (Arrival)", "Airport (Departure)"];

            $('.trip-type-get').on('change', function() {
                const selectedTripType = $(this).val();
                const $occasionSelect = $('.occasion-select').first(); // just in case multiple are present

                // Clear current options
                $occasionSelect.html('<option value="" disabled selected>Occasion...</option>');

                let filteredOccasions = [];

                if (selectedTripType === "Flat Rate") {
                    filteredOccasions = flatRateOccasions;
                } else if (selectedTripType === "As Directed/Hourly") {
                    filteredOccasions = allOccasions.filter(o => !flatRateOccasions.includes(o));
                }

                // Add new options
                $.each(filteredOccasions, function(index, item) {
                    $occasionSelect.append(`<option value="${item}">${item}</option>`);
                });

                // 🔁 Tell Nice Select to update
                $occasionSelect.niceSelect('update');
            });
