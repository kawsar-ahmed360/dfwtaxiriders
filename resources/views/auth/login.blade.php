...
<head>
    ...
    <title>DFW Taxi Riders Transportation Services</title>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(../Server/assets/images/auth-bg.jpg) no-repeat center center;">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="https://dfwtaxiriders.com/Client/assets/img/logo.png" alt="" class="w-75">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" id="email" type="text" name="email"
                                            placeholder="enter your username" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('password') is-invalid @enderror" id="pwd" type="password" name="password" required autocomplete="current-password"
        ...
        @php
                ...
                <input type="hidden" name="correct_ans" value="{{@$first_number+$second_number}}">
                 ...
                 <div class="col-md-1">
                      ...
                      <span style="font-size:29px;color:#4a4949;padding-top:5px">+</span>
                 ...
                 <div class="col-md-2">
                  ...
                  <div class="col-md-1">
                    ...
                    <span style="font-size:29px;color:black;padding-top:5px;font-weight:bold">=</span>
               ...
               <div class="col-md-3">
                ...
                <input type="number" id="right_ans" style="width: 63px;" name="right_ans" class="form-control">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="button" id="submitButton" onclick="checkSum()" class="btn w-100 btn-dark">Sign In</button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    Copyright <a href="https://dfwblackcarlimollc.com/" class="text-danger">DFW Taxi Riders Transportation Services</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
.table-primary {
   --bs-table-color: #000;
   --bs-table-bg: #dfe4fa;
   --bs-table-border-color: #c9cde1;
   --bs-table-striped-bg: #d4d9ee;
   --bs-table-striped-color: #000;
   --bs-table-active-bg: #c9cde1;
   --bs-table-active-color: #000;
   --bs-table-hover-bg: #ced3e7;
...
.table-success {
   --bs-table-color: #000;
   --bs-table-bg: #d3f4e6;
   --bs-table-border-color: #bedccf;
   --bs-table-striped-bg: #c8e8db;
   --bs-table-striped-color: #000;
   --bs-table-active-bg: #bedccf;
   --bs-table-active-color: #000;
   --bs-table-hover-bg: #c3e2d5;
   --bs-table-hover-color: #000;
   color: var(--bs-table-color);
   border-color: var(--bs-table-border-color);
}
...
.table-dark {
   --bs-table-color: #fff;
   --bs-table-bg: #1c2d41;
   --bs-table-border-color: #334254;
   --bs-table-striped-bg: #27384b;
   --bs-table-striped-color: #fff;
   --bs-table-active-bg: #334254;
   --bs-table-active-color: #fff;
   --bs-table-hover-bg: #2d3d4f;
...
.col-form-label {
   padding-top: calc(6px + var(--bs-border-width));
   padding-bottom: calc(6px + var(--bs-border-width));
   margin-bottom: 0;
   font-size: inherit;
   line-height: 1.5;
   color: #1c2d41;
...
.form-control:focus {
   ...
   outline: 0;
   box-shadow: inset 0 1px 2px rgba(var(--bs-body-color-rgb), 0.075), transparent;
}
...
textarea.form-control {
   min-height: calc(1.5em + 12px + calc($input-border-width * 2));
}
...
.form-control-color {
   width: 3rem;
   height: calc(1.5em + 12px + calc($input-border-width * 2));
   padding: 6px;
}
...
.form-select {
   --bs-form-select-bg-img: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%231c2d41' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e");
   display: block;
   width: 100%;
...
.form-select:focus {
   border-color: rgba(0, 0, 0, 0.25);
   outline: 0;
   box-shadow: unset, 0 0 0 0.25rem rgba(0, 0, 0, 0.25);
}
...
[data-bs-theme="dark"] .form-select {
   --bs-form-select-bg-img: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23b8c3d5' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e");
}
...
.form-floating::before:not(.form-control:disabled) {
   ...
   width: calc(100% - (calc(calc(0.375em + 3px) + calc(0.75em + 6px))));
   height: 1.875em;
   content: "";
   background-color: transparent;
   border-radius: 2px;
...
.form-control.is-valid {
   ...
   background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2322ca80' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
   background-repeat: no-repeat;
...
.form-select.is-valid:not([multiple])[size="1"] {
   --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2322ca80' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
   padding-right: 66px;
...
.form-control-color.is-valid {
   width: calc(3rem + calc(1.5em + 12px));
}
...
.form-control.is-invalid {
   ...
   padding-right: calc(1.5em + 12px);
   background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff4f70'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff4f70' stroke='none'/%3e%3c/svg%3e");
   background-repeat: no-repeat;
   background-position: right calc(0.375em + 3px) center;
   background-size: calc(0.75em + 6px) calc(0.75em + 6px);
}
...
.form-select.is-invalid:not([multiple])[size="1"] {
   --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff4f70'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff4f70' stroke='none'/%3e%3c/svg%3e");
   padding-right: 66px;
   background-position: right 12px center, center right 36px;
   background-size: 16px 12px, calc(0.75em + 6px) calc(0.75em + 6px);
}
...
.btn-success {
   --bs-btn-color: #fff;
   --bs-btn-bg: #22ca80;
   --bs-btn-border-color: #22ca80;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #1dac6d;
   --bs-btn-hover-border-color: #1ba266;
   --bs-btn-focus-shadow-rgb: 67, 210, 147;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #1ba266;
   --bs-btn-active-border-color: #1a9860;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fff;
   --bs-btn-disabled-bg: #22ca80;
   --bs-btn-disabled-border-color: #22ca80;
}

.btn-info {
   --bs-btn-color: #fff;
   --bs-btn-bg: #27aae1;
   --bs-btn-border-color: #27aae1;
   --bs-btn-hover-color: #27aae1;
   --bs-btn-hover-bg: transparant;
   --bs-btn-hover-border-color: #27aae1;
   --bs-btn-focus-shadow-rgb: 119, 139, 235;
   --bs-btn-active-color: #27aae1;
   --bs-btn-active-bg: transparant;
   --bs-btn-active-border-color: #27aae1;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fff;
   --bs-btn-disabled-bg: #27aae1;
   --bs-btn-disabled-border-color: #27aae1;
}

.btn-warning {
   --bs-btn-color: #000;
   --bs-btn-bg: #fdc16a;
   --bs-btn-border-color: #fdc16a;
   --bs-btn-hover-color: #000;
   --bs-btn-hover-bg: #fdca80;
   --bs-btn-hover-border-color: #fdc779;
   --bs-btn-focus-shadow-rgb: 215, 164, 90;
   --bs-btn-active-color: #000;
   --bs-btn-active-bg: #fdcd88;
   --bs-btn-active-border-color: #fdc779;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #000;
   --bs-btn-disabled-bg: #fdc16a;
   --bs-btn-disabled-border-color: #fdc16a;
}

.btn-danger {
   --bs-btn-color: #fff;
   --bs-btn-bg: #ff4f70;
   --bs-btn-border-color: #ff4f70;
   --bs-btn-hover-color: #ff4f70;
   --bs-btn-hover-bg: transparant;
   --bs-btn-hover-border-color: #ff4f70;
   --bs-btn-focus-shadow-rgb: 255, 105, 133;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: transparant;
   --bs-btn-active-border-color: #bf3b54;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fff;
   --bs-btn-disabled-bg: #ff4f70;
   --bs-btn-disabled-border-color: #ff4f70;
}

.btn-light {
   --bs-btn-color: #000;
   --bs-btn-bg: #e8eaec;
   --bs-btn-border-color: #e8eaec;
   --bs-btn-hover-color: #000;
   --bs-btn-hover-bg: #c5c7c9;
   --bs-btn-hover-border-color: #babbbd;
   --bs-btn-focus-shadow-rgb: 197, 199, 201;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #babbbd;
   --bs-btn-active-border-color: #aeb0b1;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #000;
...
.btn-dark {
   --bs-btn-color: #fff;
   --bs-btn-bg: #1c2d41;
   --bs-btn-border-color: #1c2d41;
   --bs-btn-hover-color: #1c2d41;
   --bs-btn-hover-bg: transparant;
   --bs-btn-hover-border-color: #1c2d41;
   --bs-btn-focus-shadow-rgb: 62, 77, 94;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: transparant;
   --bs-btn-active-border-color: #1c2d41;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fff;
   --bs-btn-disabled-bg: #1c2d41;
   --bs-btn-disabled-border-color: #1c2d41;
}

.btn-cyan {
   --bs-btn-color: #fff;
   --bs-btn-bg: #01caf1;
   --bs-btn-border-color: #01caf1;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #01accd;
   --bs-btn-hover-border-color: #01a2c1;
   --bs-btn-focus-shadow-rgb: 39, 210, 243;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #01a2c1;
   --bs-btn-active-border-color: #0198b5;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fff;
   --bs-btn-disabled-bg: #01caf1;
   --bs-btn-disabled-border-color: #01caf1;
}
...
.btn-orange {
   ...
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #d57700;
   --bs-btn-hover-border-color: #c97000;
   --bs-btn-focus-shadow-rgb: 252, 157, 38;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #c97000;
   --bs-btn-active-border-color: #bc6900;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fff;
...
.btn-outline-primary {
   ...
   --bs-btn-border-color: #5f76e8;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #5f76e8;
   --bs-btn-hover-border-color: #5f76e8;
   --bs-btn-focus-shadow-rgb: 95, 118, 232;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #5f76e8;
   --bs-btn-active-border-color: #5f76e8;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #5f76e8;
...
.btn-outline-success {
   ...
   --bs-btn-border-color: #22ca80;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #22ca80;
   --bs-btn-hover-border-color: #22ca80;
   --bs-btn-focus-shadow-rgb: 34, 202, 128;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #22ca80;
   --bs-btn-active-border-color: #22ca80;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #22ca80;
   --bs-btn-disabled-bg: transparent;
   --bs-btn-disabled-border-color: #22ca80;
   --bs-gradient: none;
}
...
.btn-outline-warning {
   ...
   --bs-btn-border-color: #fdc16a;
   --bs-btn-hover-color: #000;
   --bs-btn-hover-bg: #fdc16a;
   --bs-btn-hover-border-color: #fdc16a;
   --bs-btn-focus-shadow-rgb: 253, 193, 106;
   --bs-btn-active-color: #000;
   --bs-btn-active-bg: #fdc16a;
   --bs-btn-active-border-color: #fdc16a;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #fdc16a;
   --bs-btn-disabled-bg: transparent;
   --bs-btn-disabled-border-color: #fdc16a;
   --bs-gradient: none;
}
...
.btn-outline-danger {
   ...
   --bs-btn-border-color: #ff4f70;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #ff4f70;
   --bs-btn-hover-border-color: #ff4f70;
   --bs-btn-focus-shadow-rgb: 255, 79, 112;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #ff4f70;
   --bs-btn-active-border-color: #ff4f70;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #ff4f70;
   --bs-btn-disabled-bg: transparent;
   --bs-btn-disabled-border-color: #ff4f70;
   --bs-gradient: none;
}
...
.btn-outline-light {
   ...
   --bs-btn-focus-shadow-rgb: 232, 234, 236;
   --bs-btn-active-color: #000;
   --bs-btn-active-bg: #e8eaec;
   --bs-btn-active-border-color: #e8eaec;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #e8eaec;
   --bs-btn-disabled-bg: transparent;
   --bs-btn-disabled-border-color: #e8eaec;
   --bs-gradient: none;
}
...
.btn-outline-dark {
   ...
   --bs-btn-border-color: #1c2d41;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #1c2d41;
   --bs-btn-hover-border-color: #1c2d41;
   --bs-btn-focus-shadow-rgb: 28, 45, 65;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #1c2d41;
   --bs-btn-active-border-color: #1c2d41;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #1c2d41;
   --bs-btn-disabled-bg: transparent;
   --bs-btn-disabled-border-color: #1c2d41;
   --bs-gradient: none;
}
...
.btn-outline-cyan {
   ...
   --bs-btn-border-color: #01caf1;
   --bs-btn-hover-color: #fff;
   --bs-btn-hover-bg: #01caf1;
   --bs-btn-hover-border-color: #01caf1;
   --bs-btn-focus-shadow-rgb: 1, 202, 241;
   --bs-btn-active-color: #fff;
   --bs-btn-active-bg: #01caf1;
   --bs-btn-active-border-color: #01caf1;
   --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
   --bs-btn-disabled-color: #01caf1;
   --bs-btn-disabled-bg: transparent;
   --bs-btn-disabled-border-color: #01caf1;
   --bs-gradient: none;
}
...
.dropdown-menu {
   ...
   --bs-dropdown-divider-bg: #e8eaec;
   --bs-dropdown-divider-margin-y: 0.5rem;
   --bs-dropdown-box-shadow: 1px 1px 15px rgba(0, 0, 0, 0.1);
   --bs-dropdown-link-color: #6c757d;
   --bs-dropdown-link-hover-color: #6c757d;
   --bs-dropdown-link-hover-bg: var(--bs-tertiary-bg);
   --bs-dropdown-link-active-color: #fff;
   --bs-dropdown-link-active-bg: #5f76e8;
   --bs-dropdown-link-disabled-color: #b8c3d5;
...
.dropdown-menu-dark {
   ...
   --bs-dropdown-link-active-bg: #5f76e8;
   --bs-dropdown-link-disabled-color: #b8c3d5;
   --bs-dropdown-header-color: #b8c3d5;
}
...
.nav-pills {
   ...
   --bs-nav-pills-link-active-bg: #5f76e8;
}
.nav-pills .nav-link {
   background: none;
   border: 0;
...
.navbar {
   ...
   --bs-navbar-color: #b8c3d5;
   --bs-navbar-hover-color: #1c2d41;
   ...
   --bs-navbar-toggler-icon-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28124, 135, 152, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
...
.accordion {
   ...
   --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237c8798'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
   --bs-accordion-btn-icon-width: 1.25rem;
   --bs-accordion-btn-icon-transform: rotate(-180deg);
   --bs-accordion-btn-icon-transition: transform 0.2s ease-in-out;
   --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%234c5eba'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
...
[data-bs-theme="dark"] .accordion-button::after {
   --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%239fadf1'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
   --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%239fadf1'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.pagination {
   ...
   --bs-pagination-active-bg: #5f76e8;
   --bs-pagination-active-border-color: #5f76e8;
...
.progress-stacked {
   ...
   --bs-progress-bg: rgba(0, 0, 0, 0.05);
   --bs-progress-border-radius: 0.25rem;
   --bs-progress-box-shadow: var(--bs-box-shadow-inset);
   --bs-progress-bar-color: #fff;
   --bs-progress-bar-bg: #5f76e8;
...
.list-group {
   ...
   --bs-list-group-disabled-bg: transparant;
   --bs-list-group-active-color: #fff;
   --bs-list-group-active-bg: #5f76e8;
   --bs-list-group-active-border-color: #5f76e8;
   display: flex;
   flex-direction: column;
   padding-left: 0;
   margin-bottom: 0;
...
.modal {
   ...
   --bs-modal-box-shadow: 0px 2px 9px 0px rgba(169, 184, 200, 0.2);
...
.offcanvas-sm {
   ...
   --bs-offcanvas-box-shadow: 0px 2px 9px 0px rgba(169, 184, 200, 0.2);
...
.text-bg-primary {
   color: #fff !important;
   background-color: RGBA(95, 118, 232, var(--bs-bg-opacity, 1)) !important;
}
...
.text-bg-success {
   color: #fff !important;
   background-color: RGBA(34, 202, 128, var(--bs-bg-opacity, 1)) !important;
}
...
.text-bg-warning {
   color: #000 !important;
   background-color: RGBA(253, 193, 106, var(--bs-bg-opacity, 1)) !important;
}

.text-bg-danger {
   color: #fff !important;
   background-color: RGBA(255, 79, 112, var(--bs-bg-opacity, 1)) !important;
}

.text-bg-light {
   color: #000 !important;
   background-color: RGBA(232, 234, 236, var(--bs-bg-opacity, 1)) !important;
}

.text-bg-dark {
   color: #fff !important;
   background-color: RGBA(28, 45, 65, var(--bs-bg-opacity, 1)) !important;
}

.text-bg-cyan {
   color: #fff !important;
   background-color: RGBA(1, 202, 241, var(--bs-bg-opacity, 1)) !important;
}
...
.topbar .top-navbar .navbar-header {
   line-height: 80px;
   background: transparent;
   box-shadow: 0 -7px 9px 0 rgba(169, 184, 200, 0.15);
   -webkit-box-shadow: 0 -7px 9px 0 rgba(169, 184, 200, 0.15);
   -moz-box-shadow: 0 -7px 9px 0 rgba(169, 184, 200, 0.15);
}
...
.sidebar-shadow {
   box-shadow: 0px 3px 9px 0px rgba(162, 176, 190, 0.15);
   -webkit-box-shadow: 0px 3px 9px 0px rgba(162, 176, 190, 0.15);
   -moz-box-shadow: 0px 3px 9px 0px rgba(162, 176, 190, 0.15);
}
...
.sidebar-nav #sidebarnav .sidebar-item.selected > .sidebar-link {
   ...
   box-shadow: 0px 7px 12px 0px rgba(39, 170, 225, 0.21);
   opacity: 1;
}
...
.custom-shadow {
   ...
   -webkit-box-shadow: 0 2px 9px 0 rgba(169, 184, 200, 0.2);
   -moz-box-shadow: 0 2px 9px 0 rgba(169, 184, 200, 0.2);
}
...
.upload-round-image img {
   width: 150px;
   height: 150px;
   margin: auto;
}
.upload-round-image i {
   position: absolute;
   right: 10px;
   top: 0px;
   font-size: 16px;
...
.upload-image-wrapper input::before {
   content: "Choose file";
   display: inline-block;
...
.upload-image-wrapper h4 {
   color: #666;
   font-size: 16px;
   line-height: 26px;
}
.upload-image-wrapper h4 span {
   color: #333;
   font-weight: 500;
}
.costom-label {
...
@font-face {
   font-family: "TofinoPersonal-Medium";
   src: url("../css/fonts/TofinoPersonal-Medium.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/TofinoPersonal-Medium.otf") format("opentype"),
      url("../css/fonts/TofinoPersonal-Medium.woff") format("woff"),
      url("../css/fonts/TofinoPersonal-Medium.ttf") format("truetype"),
      url("../css/fonts/TofinoPersonal-Medium.svg#TofinoPersonal-Medium") format("svg");
   font-weight: normal;
   font-style: normal;
}
@font-face {
   font-family: "TofinoPersonal-Regular";
   src: url("../css/fonts/TofinoPersonal-Regular.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/TofinoPersonal-Regular.otf") format("opentype"),
      url("../css/fonts/TofinoPersonal-Regular.woff") format("woff"),
      url("../css/fonts/TofinoPersonal-Regular.ttf") format("truetype"),
      url("../css/fonts/TofinoPersonal-Regular.svg#TofinoPersonal-Regular") format("svg");
   font-weight: normal;
   font-style: normal;
}
@font-face {
   font-family: "TofinoPersonal-Book";
   src: url("../css/fonts/TofinoPersonal-Book.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/TofinoPersonal-Book.otf") format("opentype"),
      url("../css/fonts/TofinoPersonal-Book.woff") format("woff"),
      url("../css/fonts/TofinoPersonal-Book.ttf") format("truetype"),
      url("../css/fonts/TofinoPersonal-Book.svg#TofinoPersonal-Book") format("svg");
   font-weight: normal;
   font-style: normal;
}
@font-face {
   font-family: "Gilmer-Heavy";
   src: url("../css/fonts/Gilmer-Heavy.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/Gilmer-Heavy.otf") format("opentype"), url("../css/fonts/Gilmer-Heavy.woff") format("woff"),
      url("../css/fonts/Gilmer-Heavy.ttf") format("truetype"),
      url("../css/fonts/Gilmer-Heavy.svg#Gilmer-Heavy") format("svg");
   font-weight: normal;
   font-style: normal;
}
@font-face {
   font-family: "Gilmer-Regular";
   src: url("../css/fonts/Gilmer-Regular.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/Gilmer-Regular.otf") format("opentype"), url("../css/fonts/Gilmer-Regular.woff") format("woff"),
      url("../css/fonts/Gilmer-Regular.ttf") format("truetype"),
      url("../css/fonts/Gilmer-Regular.svg#Gilmer-Regular") format("svg");
   font-weight: normal;
   font-style: normal;
}
@font-face {
   font-family: "Gilmer-Medium";
   src: url("../css/fonts/Gilmer-Medium.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/Gilmer-Medium.otf") format("opentype"), url("../css/fonts/Gilmer-Medium.woff") format("woff"),
      url("../css/fonts/Gilmer-Medium.ttf") format("truetype"),
      url("../css/fonts/Gilmer-Medium.svg#Gilmer-Medium") format("svg");
   font-weight: normal;
   font-style: normal;
}
@font-face {
   font-family: "Gilmer-Bold";
   src: url("../css/fonts/Gilmer-Bold.eot?#iefix") format("embedded-opentype"),
      url("../css/fonts/Gilmer-Bold.otf") format("opentype"), url("../css/fonts/Gilmer-Bold.woff") format("woff"),
      url("../css/fonts/Gilmer-Bold.ttf") format("truetype"),
      url("../css/fonts/Gilmer-Bold.svg#Gilmer-Bold") format("svg");
   font-weight: normal;
   font-style: normal;
}
...
$(document).ready(function() {
    function validateAnswer() {
        ...
        var rightAns = $("#right_ans").val();

        // Check if input is empty
        if (rightAns.trim() === '') {
            return { status: false, message: "Please enter the answer." };
        }

        var numericAnswer = parseFloat(rightAns);
        var correctAnswer = firstNumber + secondNumber;

        if (numericAnswer === correctAnswer) {
            return { status: true };
        } else {
            return { status: false, message: "Incorrect answer. Please solve the sum correctly." };
        }
    }

    // Real-time input checking
    $("#right_ans").on('keyup', function() {
        var result = validateAnswer();
        if (result.status) {
