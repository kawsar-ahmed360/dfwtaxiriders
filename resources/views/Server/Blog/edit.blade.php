                ...
                <div class="card-body">
                      ...
                      <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                  ...
                                  name="short"  placeholder="Text Here...">{!!@$edit->short!!}</textarea>
                               </div>
                            ...
                            <div class="form-group mb-3">
                             ...
                             <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                  ...
                                  name="meta_key"  placeholder="Text Here...">{!!@$edit->meta_key!!}</textarea>
                               </div>
                                ...
                                <div class="form-group mb-3">
                                  ...
                                  <textarea id="editor" class="form-control custom-shadow bg-white" rows="3"
                                  name="meta_des"  placeholder="Text Here...">{!!@$edit->meta_des!!}</textarea>
                               </div>
