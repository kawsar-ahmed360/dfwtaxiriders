            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive" style="padding:20px">
                        <a id="delete_multiple" class="btn btn-primary btn-sm visible_delete_icon" style="display:none"><i
                                class="fa fa-trash"></i> <span id="del_count"></span> Delete</a>
                            ...
                            <tbody>
                                @foreach (@$list as $key => $l)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$l->email}}</td>
                                        <td>{{$l->phone}}</td>
                                        <td><button class="btn btn-info btn-sm" onclick="showmessage('{{ $l->message }}')">Click
                                                Me</button></td>
                                        ...
                                        @if(Auth::user()->role == 2)
                                            ...
                                            <td>
                                                <a id="delete" href="{{route('ContactMessageDelete', @$l->id)}}"
                                                    class="btn waves-effect waves-light btn-rounded btn-danger btn-sm">
                                                    Delete
                                                </a>
                                            </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" onclick="hidemessage()" class="close btn btn-danger btn-sm" data-dismiss="modal"
                        aria-label="Close">
