...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '0f63808fa1838d9fbb320f1382f0586fa094d955941b2c5dc16f417d31b1cfed';
	const ERROR_REPORTING_LEVEL = '0';
	const DEPLOYED_HOSTNAME = 'dfwtaxiriders.com';
	const CLOUD_HOSTNAME = 'pages.weeblycloud.com';
	const DEPLOYED_HOSTNAME_HEADER = 'X-W-Cloud-Host';
	const BUILDDATE = '1758047939';
	const DEPLOYED_REPOSITORY = 'live';
	const ORIGIN_API_ENDPOINT = 'https://api.weeblycloud.com/private/';
	const CLIENT_API_ENDPOINT = 'https://pages.weeblycloud.com/';
